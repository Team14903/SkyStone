...
//@Disabled
@TeleOp(name= "TeleOp Basic Program(Thomas)")
public class RoverRuckusTeleOpThomas extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        while(opModeIsActive()) {
            ...
            rotatingArmMotor.setPower(gamepad2.right_trigger-(gamepad2.left_trigger/2));
