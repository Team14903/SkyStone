...
@Disabled
@TeleOp(name= "TeleOp Right Program")
public class SkystoneTeleOpRightStick extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException{
       ...
       TerrenceTheServo = hardwareMap.servo.get("TerrenceTheServo");
        ...
        while(opModeIsActive()) {
            ...
            }else if(gamepad1.left_bumper&&((Math.abs(gamepad1.right_stick_x)+Math.abs(gamepad1.right_stick_y))>0)) {
                motorFrontLeft.setPower((-gamepad1.right_stick_y+gamepad1.right_stick_x)/2);
                motorFrontRight.setPower((gamepad1.right_stick_y+gamepad1.right_stick_x)/2);
                motorBackLeft.setPower((-gamepad1.right_stick_y-gamepad1.right_stick_x)/2);
                motorBackRight.setPower((gamepad1.right_stick_y-gamepad1.right_stick_x)/2);
            } else if((Math.abs(gamepad1.right_stick_x)+Math.abs(gamepad1.right_stick_y)>0)) {
            ...
            Log.d("Gamepad.1.y","Gamepady="+(gamepad1.right_stick_y));
            ...
            */
            ...
            if(!(gamepad2.right_stick_y==0)) {
                linearslideLeft.setPower(gamepad2.left_bumper ? gamepad2.right_stick_y: gamepad2.right_stick_y/2);
            }else {
